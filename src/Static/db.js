...
import artes from "../img/artes.png"
import { BsFacebook, BsInstagram } from "react-icons/bs"
import { FaYoutube } from "react-icons/fa";
import bookimg1 from "../img/1.jpg"
import bookimg2 from "../img/2.jpg"
import bookimg3 from "../img/3.jpg"
import bookimg4 from "../img/4.jpg"
import bookimg5 from "../img/5.jpg"
import bookimg6 from "../img/6.jpg"
import bookimg7 from "../img/7.jpg"
import bookimg8 from "../img/8.jpg"
import bookimg9 from "../img/9.jpg"
...
export const Artists = [
    {
        ...
        sub: "Behind every masterpiece is a skilled artist. Get to know our passionate Mehndi experts dedicated to creating unforgettable moments through their art.",
        btn: "Meet the Artists"
    }
]
export const about = [
    {
        title: " about US",
        sub: "Mehendi is the art of painting the body in ornate designs with henna, associated with transformation and transcendence. We, dummy company situated at area, city, state, provide beautiful mehendi designs as a trendy alternative to tattoos. We are proud to be able to evolve from the traditional patterns of mehendi into more and more intricate and decorative designs in time. The unique designs and intricacy of the mehendi makes it an outstanding work of art.",
        img: aboutimg
...
export const whyus = [
    {
        title: "why choose us ?",
        sub: "A Simple Yet Effective four Step Procress",

        step: [
            {
                icon: tree,
                sub: "Skin friendly and dark color mehendi - We make the henna paste with 100% natural heena powder, lemon juice and essential oils but still deliver great color and shade.",

            },
            {
                icon: art,
                sub: "We have artists with expertise in many types of mehendi patterns, most popular ones being the Arabic and Rajasthani designs.",

            },
            {
                icon: money,
                sub: "Customized price range for all. Easy, affordable and reliable, we offer tremendous value to customers at a reasonable prices",

            },
            {
                icon: artes,
                sub: "We Have evolved the traditional patterns of mehendi into intricate and decorative designs."
            }
        ]
    },
...
export const testimonial = [
    ...
    {
        star: "⭐⭐⭐⭐⭐",
        title: "we have no regrest!",
        details: "involves the use of websites, social media, search engines, and apps—anything that incorporates marketing with customer feedback or a two-way interaction between the company and its customers",
...
export const book = [
    {
        title: "Book Your Mehndi Session ",
        sub: "Ready to adorn yourself with Mehndi magic? Contact us to schedule your personalized Mehndi session or inquire about our services",
        service: "book now ",
        contact: "contact Us",
        img: [
            {
        ...
        mediaicon: [
            ...
            {
                icons: <BsInstagram size={24} />,
                link: "https://www.instagram.com/karaikudi_mehandi_artist_maha/"
            },
            {
                icons: <FaYoutube size={28} />,
                link: "https://www.youtube.com/channel/UCDYbZLC4eFlohfVZqUlVRLg"
            },
        ]
